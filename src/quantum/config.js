...
const TP6_SITES_DATA = {
  ...
  data: [
    ...
    ['geckoview',         'cold', 'Tp6 mobile: Amazon',               { eq: { suite: ['raptor-tp6m-cold-amazon-geckoview', 'raptor-tp6m-amazon-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Amazon Search',        { eq: { suite: ['raptor-tp6m-cold-amazon-search-geckoview', 'raptor-tp6m-amazon-search-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Aframe.io',            { eq: { suite: ['raptor-tp6m-cold-aframeio-animation-geckoview', 'raptor-tp6m-aframeio-animation-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: All Recipes',          { eq: { suite: ['raptor-tp6m-cold-allrecipes-geckoview', 'raptor-tp6m-allrecipes-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: BBC',                  { eq: { suite: ['raptor-tp6m-cold-bbc-geckoview', 'raptor-tp6m-bbc-geckovew-cold']} }],
    ['geckoview',         'cold', 'Tp6 mobile: Bing',                 { eq: { suite: ['raptor-tp6m-cold-bing-geckoview', 'raptor-tp6m-bing-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Bing Restaurants',     { eq: { suite: ['raptor-tp6m-cold-bing-restaurants-geckoview', 'raptor-tp6m-bing-restaurants-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Booking',              { eq: { suite: ['raptor-tp6m-cold-booking-geckoview', 'raptor-tp6m-booking-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: CNN',                  { eq: { suite: ['raptor-tp6m-cold-cnn-geckoview', 'raptor-tp6m-cnn-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: CNN AmpStories',       { eq: { suite: ['raptor-tp6m-cold-cnn-ampstories-geckoview', 'raptor-tp6m-cnn-ampstories-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Kleinanzeigen',        { eq: { suite: ['raptor-tp6m-cold-ebay-kleinanzeigen-geckoview', 'raptor-tp6m-ebay-kleinanzeigen-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Kleinanzeigen Search', { eq: { suite: ['raptor-tp6m-cold-ebay-kleinanzeigen-search-geckoview', 'raptor-tp6m-ebay-kleinanzeigen-search-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: ESPN',                 { eq: { suite: ['raptor-tp6m-cold-espn-geckoview', 'raptor-tp6m-espn-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Facebook',             { eq: { suite: ['raptor-tp6m-cold-facebook-geckoview', 'raptor-tp6m-facebook-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Facebook Cristiano',   { eq: { suite: ['raptor-tp6m-cold-facebook-cristiano-geckoview', 'raptor-tp6m-facebook-cristiano-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Google',               { eq: { suite: ['raptor-tp6m-cold-google-geckoview', 'raptor-tp6m-google-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Google Maps',          { eq: { suite: ['raptor-tp6m-cold-google-maps-geckoview', 'raptor-tp6m-google-maps-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Google Restaurants',   { eq: { suite: ['raptor-tp6m-cold-google-restaurants-geckoview', 'raptor-tp6m-google-restaurants-geckovew-cold']} }],
    ['geckoview',         'cold', 'Tp6 mobile: Instagram',            { eq: { suite: ['raptor-tp6m-cold-instagram-geckoview', 'raptor-tp6m-instagram-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Imdb',                 { eq: { suite: ['raptor-tp6m-cold-imdb-geckoview', 'raptor-tp6m-imdb-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Jianshu',              { eq: { suite: ['raptor-tp6m-cold-jianshu-geckoview', 'raptor-tp6m-jianshu-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Microsoft Support',    { eq: { suite: ['raptor-tp6m-cold-microsoft-support-geckoview', 'raptor-tp6m-microsoft-support-geckovew-cold']} }],
    ['geckoview',         'cold', 'Tp6 mobile: Reddit',               { eq: { suite: ['raptor-tp6m-cold-reddit-geckoview', 'raptor-tp6m-reddit-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Stackoverflow',        { eq: { suite: ['raptor-tp6m-cold-stackoverflow-geckoview', 'raptor-tp6m-stackoverflow-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Web.de',               { eq: { suite: ['raptor-tp6m-cold-web-de-geckoview', 'raptor-tp6m-web-de-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: Wikipedia',            { eq: { suite: ['raptor-tp6m-cold-wikipedia-geckoview', 'raptor-tp6m-wikipedia-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: YouTube',              { eq: { suite: ['raptor-tp6m-cold-youtube-geckoview', 'raptor-tp6m-youtube-geckovew-cold']}}],
    ['geckoview',         'cold', 'Tp6 mobile: YouTube Watch',        { eq: { suite: ['raptor-tp6m-cold-youtube-watch-geckoview', 'raptor-tp6m-youtube-watch-geckovew-cold']}}],
