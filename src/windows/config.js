...
const TP6_SITES_DATA = {
  ...
  data: [
    ...
    ['fenix', 'cold', 'Tp6 mobile: Aframe.io', { eq: { suite: ['aframeio-animation-cold'], framework: 13, repo: 'fenix' } }],
    ...
    ['fenix', 'cold', 'Tp6 mobile: Bing Restaurants', { eq: { suite: ['bing-restaurants-cold'], framework: 13, repo: 'fenix' } }],
    ...
    ['fenix', 'cold', 'Tp6 mobile: Kleinanzeigen', { eq: { suite: ['kleinanzeigen-cold'], framework: 13, repo: 'fenix' } }],
    ['fenix', 'cold', 'Tp6 mobile: Kleinanzeigen Search', { eq: { suite: ['kleinanzeigen-search-cold'], framework: 13, repo: 'fenix' } }],
    ...
    ['fenix', 'cold', 'Tp6 mobile: Google Restaurants', { eq: { suite: ['google-restaurants-cold'], framework: 13, repo: 'fenix' } }],
