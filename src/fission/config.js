...
const PERFORMANCE_COMBO_TABLE = {
  ...
  data: [
    ...
    ['sessionrestore_many_windows', 'Sessionrestore many windows', 'sessionrestore_many_windows'],
    ['startup_about_home_paint', 'Startup about home paint', 'startup_about_home_paint'],
    ['startup_about_home_paint_realworld_webextensions', 'Startup about home paint realworld webextensions', 'startup_about_home_paint_realworld_webextensions'],
